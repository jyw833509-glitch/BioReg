// Frozen V1.0.0 reference used only to verify optimization equivalence.
import { sequential } from "../src/server/sequential";
import type { Db } from "../src/server/db";
import {
  dayRange,
  regulationRepository,
} from "../src/server/repositories/regulation-repository";
import type { DashboardView } from "../src/lib/view-types";
import { documentLabels } from "../src/lib/labels";
import { regulationDto } from "../src/server/mappers";
import { officialOnly, visibleWhere } from "../src/server/visibility";
